...
using MNIST_MLdotNet.DataStructures;
...
namespace MNIST_MLdotNet
{
    class Program
    {
        ...
        private static string ONNXRelativePath = $"{BaseModelsRelativePath}/MNIST.onnx";

        private static string ModelPath = GetAbsolutePath(ModelRelativePath);
        private static string ONNXPath = GetAbsolutePath(ONNXRelativePath);
